...
cap = cv2.VideoCapture(0)  # Utiliza la cámara predeterminada (cámara web) 
...
while True:
    ...
    # Verifica si se detecta una persona con confianza//// confianza del 75% de prediccion
    person_detected = any(detection[2] > 0.75 for detection in detections[0][0] if classes[int(detection[1])] == "Persona")
    ...
    for detection in detections[0][0]:
        ...
        if detection[2] > 0.75:
            ...
            #    if label == "Persona" and aula == "Aula Vacia":
            #         aula="Aula Ocupada"
            #         print("encender Luces")
            #    elif label == "Persona" and aula == "Aula Ocupada" :
            #         #aula= "Aula Vacia"
            #         print(aula)
            #    else :
            #         aula= "Aula Vacia"
